...
(function() {
    ...
    var db = B("Opera") || B("OPR"),
        C = B("Trident") || B("MSIE"),
        D = B("Edge"),
        E = B("Gecko") && !(-1 != ab.toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"),
        F = -1 != ab.toLowerCase().indexOf("webkit") && !B("Edge"),
        G = B("Macintosh"),
        eb = function() {
            var a = ab;
        ...
        ib = m.document,
        jb = ib && C ? fb() || ("CSS1Compat" == ib.compatMode ? parseInt(gb, 10) : 5) : void 0;
    var kb = !C || 9 <= jb,
        lb = !E && !C || C && 9 <= jb || E && H("1.9.1"),
        mb = C && !H("9");
    var pb = function(a) {
        ...
        Eb = function(a, b, c) {
            if (!(a.nodeName in zb))
                ...
                else if (a.nodeName in Ab) b.push(Ab[a.nodeName]);
            else
                for (a = a.firstChild; a;) Eb(a, b, c), a = a.nextSibling
        },
        ub = function(a) {
    ...
    var Tb = function(a) {
        ...
        Vb = function(a, b, c, d, e, f) {
            ...
            b = a.a[g];
            b || (b = a.a[g] = [], a.b++);
            var k = Ub(b, c, e, f); - 1 < k ? (a = b[k], d || (a.xa = !1)) : (a = new Rb(c, a.src, g, !!e, f), a.xa = d, b.push(a));
            return a
        };
    ...
    var Yb = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        fc = function(a, b, c, d, e) {
            ...
            else c = ac(c), a && a[Pb] ? a.S(b, c, d, e) : a && (a = bc(a)) && (b = Xb(a, b, c, !!d, e)) && gc(b)
        },
        gc = function(a) {
            if (!fa(a) && a && !a.removed) {
                var b = a.src;
        ...
        ec = function(a, b) {
            ...
            if (!Ib) {
                ...
                if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                    ...
                    for (g = 0; !c.c && g < e.length; g++) c.a = e[g],
                    k = ic(e[g], f, !1, c),
                    d = d && k
                }
                return d
    ...
    var mc = "StopIteration" in m ? m.StopIteration : {
    ...
    var rc = function(a) {
        ...
        sc = function(a, b, c) {
            ...
            else if (ea(a) || q(a)) z(a, b, c);
            else {
                var d;
                if (a.R && "function" == typeof a.R) d = a.R();
                else if (a.G && "function" == typeof a.G) d = void 0;
                else if (ea(a) || q(a)) {
                    d = [];
    ...
    M.prototype.R = function() {
        Jc(this);
        for (var a = this.a.G(), b = this.a.R(), c = [], d = 0; d < b.length; d++)
    ...
    M.prototype.G = function(a) {
        Jc(this);
        var b = [];
        if (q(a)) Lc(this, a) && (b = Oa(b, this.a.get(Kc(this, a))));
        else {
            a = this.a.G();
    ...
    M.prototype.toString = function() {
        ...
        for (var a = [], b = this.a.R(), c = 0; c < b.length; c++)
            for (var d = b[c], e = encodeURIComponent(String(d)), d = this.G(d), f = 0; f < d.length; f++) {
                var g = e;
    ...
    var Q = function(a, b) {
        ...
        var d = a.nb,
            ...
            f = e.type || e;
        if (q(e)) e = new Mb(e, d);
        else if (e instanceof Mb) e.target = e.target || d;
        else {
            var g = e,
                e = new Mb(f, d);
            Wa(e, g)
        ...
        var g = !0,
            k;
        if (c)
            for (var l = c.length - 1; !e.c && 0 <= l; l--) k = e.a = c[l], g = gd(k, f, !0, e) && g;
        e.c || (k = e.a = d, g = gd(k, f, !0, e) && g, e.c || (g = gd(k, f, !1, e) && g));
        if (c)
            for (l = 0; !e.c && l < c.length; l++) k = e.a = c[l], g = gd(k, f, !1, e) && g;
        return g
    };
    ...
    h.vb = function(a) {
        if (F || D)
            if (17 == this.H && !a.ctrlKey || 18 == this.H && !a.altKey || G && 91 == this.H && !a.metaKey) this.V = this.H = -1; - 1 == this.H && (a.ctrlKey && 17 != a.keyCode ? this.H = 17 : a.altKey && 18 != a.keyCode ? this.H = 18 : a.metaKey && 91 != a.keyCode && (this.H = 91));
    ...
    h.S = function(a, b, c, d, e) {
        ...
        else c = c || this.handleEvent, e = e || this.b || this, c = ac(c), d = !!d, b = a && a[Pb] ? Xb(a.L, String(b), c, d, e) : a ? (a = bc(a)) ? Xb(a, b, c, d, e) : null : null, b && (gc(b), delete this.a[b.Xa]);
        return this
    };
    ...
    R.prototype.removeChild = function(a, b) {
        if (a) {
            var c = q(a) ? a : a.C || (a.C = ":" + (a.pb.a++).toString(36)),
                d;
    ...
    h.Na = function(a, b) {
        var c = !b,
            d = C || db ? a.getElementsByTagName("*") : null;
        if (lc) {
            if (c = c ? "none" : "", a.style && (a.style[lc] = c), d)
                for (var e = 0, f; f = d[e]; e++) f.style && (f.style[lc] = c)
        } else if (C || db)
            ...
            if (0 == a.a) {
                ...
                a: {
                    var e = c,
                        f = a.s,
                        g = a.w;
                    if (e instanceof ue) null != f && Ca(f, "opt_onFulfilled should be a function."),
                    null != g && Ca(g, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"),
                    De(e, xe(f || n, g || null, a)),
                    d = !0;
                    else if (re(e)) e.then(f, g, a),
                    d = !0;
                    else {
                        if (ga(e)) try {
                            var k = e.then;
    ...
    var Se = function(a) {
        ...
        Qe = /[\x00\x22\x27\x3c\x3e]/g,
        Ue = /^(?!on|src|(?:style|action|archive|background|cite|classid|codebase|data|dsync|href|longdesc|usemap)\s*$)(?:[a-z0-9_$:-]*)$/i,
        Oe = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g,
        Pe = /</g;
    var Ve = function(a) {
        var b;
        a = a || {};
        var c = Le,
            d = '<div role="button"' + (a.id ? ' id="' + Se(a.id) + '"' : "") + ' class="',
            e, f;
        e = a || {};
    ...
    h.ha = function(a) {
        ...
        a: {
            var d = Ve(c || Zc);c = (b || pb()).a.createElement("DIV");
            var d = Yc(d),
                e = d.match(ad);y(!e, "This template starts with a %s, which cannot be a child of a <div>, as required by soy internals. Consider using goog.soy.renderElement instead.\nTemplate output: %s", e && e[0], d);c.innerHTML = d;
    ...
    var of = new nf("SEVERE", 1E3),
        pf = new nf("CONFIG", 700),
        qf = new nf("FINE", 500);
    ...
    mf.prototype.log = function(a, b, c) {
        if (a.value >= rf(this).value)
            for (r(b) && (b = b()), a = new kf(a, String(b), this.f), c && (a.a = c), c = "log:" + a.getMessage(), m.console && (m.console.timeStamp ? m.console.timeStamp(c) : m.console.markTimeline && m.console.markTimeline(c)), m.msWriteProfilerMark && m.msWriteProfilerMark(c), c = this; c;) c = c.a
    };
    var sf = {},
        tf = null,
        uf = function(a) {
    ...
    var Nf = function(a) {
            if (a.b && "undefined" != typeof aa)
                if (a.D[1] && 4 == Of(a) && 2 == Pf(a)) X(a.I, Hf(a, "Local request error detected and ignored"));
                else if (a.l && 4 == Of(a)) Ie(a.$, 0, a);
            else if (Q(a, "readystatechange"), 4 == Of(a)) {
                X(a.I, Hf(a, "Request complete"));
                a.b = !1;
                try {
                    if (Qf(a)) Q(a, "complete"), Q(a, "success");
                    else {
                        var b;
                        try {
    ...
    var Xf = function(a) {
        ...
        $f = function(a) {
            ...
            b = Zf;
            var d = Xf(String.fromCharCode(116)),
                c = Xf(String.fromCharCode(107)),
                d = [d(), d()];
            d[1] = c();
            for (var c = "&" + d.join("") + "=", d = [],
    ...
    */
    ...
    gg.prototype.cancel = function(a) {
        if (this.a) this.c instanceof gg && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
    ...
    var Xc = function(a) {
        ...
        if (a.query)
            if (a.lb) {
                for (var b = b + '<div class="gtx-language"><select class="gtx-lang-selector">', c = a.zb, d = c.length, e = 0; e < d; e++) var f = c[e],
                    b = b + ("auto" != f ? '<option value="' + V(f[0]) + '" ' + (f[0] == a.yb ? "selected" : "") + ">" + V(f[1]) + "</option>" : "");
                ...
                if (a.Wa) {
                    ...
                    for (e = 0; e < d; e++) {
                        ...
                        if (a.popup)
                            for (var f = f.terms, g = f.length, k = 0; k < g; k++) b += (0 != k ? ", " : "") + V(f[k]);
                        else
    ...
    Jg.prototype.a = function(a, b, c, d) {
        if (null != d) {
            ...
            Bd(b, d);
            fg(b, k, f);
            e = "https://translate.google.cn/?source=gtx_m#" +
    ...
    var Lg = Jg.M(),
        Mg = chrome.extension.getBackgroundPage();
