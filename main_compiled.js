...
(function() {
    ...
    var ma = "StopIteration" in h ? h.StopIteration : {
    ...
    */
    ...
    var T = function(a, b) {
        ...
        Rb = function(a, b) {
            return "https://translate.google.cn/?source=gtx_c#auto/" + a + "/" + encodeURIComponent(b)
        };
    var U = function(a) {
            this.b = [];
