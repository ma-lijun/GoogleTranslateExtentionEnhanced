...
(function() {
    ...
    var la = function(a, b) {
        ...
        va = function(a) {
            if (!oa.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(pa, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(qa, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(ra, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(sa, "&quot;")); - 1 != a.indexOf("'") &&
                (a = a.replace(ta, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(ua, "&#0;"));
            return a
        },
        pa = /&/g,
        qa = /</g,
    ...
    var Db = G("Opera") || G("OPR"),
        H = G("Trident") || G("MSIE"),
        Eb = G("Edge"),
        Fb = Eb || H,
        I = G("Gecko") && !(-1 != Ab.toLowerCase().indexOf("webkit") && !G("Edge")) && !(G("Trident") || G("MSIE")) && !G("Edge"),
        J = -1 != Ab.toLowerCase().indexOf("webkit") && !G("Edge"),
        Gb = J && G("Mobile"),
        Hb = G("Macintosh"),
        Ib = function() {
            var a = Ab;
        ...
        Mb = m.document,
        Nb = Mb && H ? Jb() || ("CSS1Compat" == Mb.compatMode ? parseInt(Kb, 10) : 5) : void 0;
    var Ob = !H || 9 <= Nb,
        Pb = !I && !H || H && 9 <= Nb || I && K("1.9.1"),
        Qb = H && !K("9");
    var Sb = function(a) {
        ...
        kc = function(a, b, c) {
            if (!(a.nodeName in fc))
                ...
                else if (a.nodeName in gc) b.push(gc[a.nodeName]);
            else
    ...
    var Dc = function(a) {
        ...
        Fc = function(a, b, c, d, e, f) {
            ...
            b = a.a[g];
            b || (b = a.a[g] = [], a.b++);
            var k = Ec(b, c, e, f); - 1 < k ? (a = b[k], d || (a.Da = !1)) : (a = new Bc(c, a.src, g, !!e, f), a.Da = d, b.push(a));
            return a
        };
    ...
    var Ic = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Rc = function(a, b, c, d, e) {
            ...
            else c = Lc(c), zc(a) ? Fc(a.F, String(b), c, !0, d, e) : Mc(a, b, c, !0, d, e)
        },
        Sc = function(a, b, c, d, e) {
            if (u(b))
                for (var f = 0; f < b.length; f++) Sc(a, b[f], c, d, e);
            else c = Lc(c), zc(a) ? a.F.remove(String(b), c, d, e) : a && (a = Nc(a)) && (b = Hc(a, b, c, !!d, e)) && Tc(b)
        },
        Tc = function(a) {
        ...
        Uc = function(a) {
            if (a)
                if (zc(a)) a.F && a.F.removeAll(void 0);
                else if (a = Nc(a)) {
                var b = 0,
                    c;
                for (c in a.a)
                    for (var d = a.a[c].concat(), e = 0; e < d.length; ++e) Tc(d[e]) && ++b
            }
        },
        Pc = function(a) {
        ...
        Qc = function(a, b) {
            ...
            if (!qc) {
                ...
                if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                    ...
                    for (g = 0; !c.ia && g < e.length; g++) c.currentTarget = e[g],
                    k = Wc(e[g], f, !1, c),
                    d = d && k
                }
                return d
    ...
    var jd = function(a, b, c, d, e, f) {
        ...
        else d = d || a.handleEvent, f = f || a.b || a, d = Lc(d), e = !!e, c = zc(b) ? Hc(b.F, String(c), d, e, f) : b ? (b = Nc(b)) ? Hc(b, c, d, e, f) : null : null, c && (Tc(c), delete a.a[c.lb]);
        return a
    };
    ...
    var pd = function() {},
        qd = new pd,
        rd = ["click", I ? "keypress" : "keydown", "keyup"];
    ...
    var Q = function(a, b) {
        ...
        var d = a.Gb,
            ...
            f = e.type || e;
        if (v(e)) e = new vc(e, d);
        else if (e instanceof vc) e.target = e.target || d;
        else {
            var g = e,
                e = new vc(f, d);
            Za(e, g)
        ...
        var g = !0,
            k;
        if (c)
            for (var l = c.length - 1; !e.ia && 0 <= l; l--) k = e.currentTarget = c[l], g = td(k, f, !0, e) && g;
        e.ia || (k = e.currentTarget = d, g = td(k, f, !0, e) && g, e.ia || (g = td(k, f, !1, e) && g));
        if (c)
            for (l = 0; !e.ia && l < c.length; l++) k = e.currentTarget = c[l], g = td(k, f, !1, e) && g;
        return g
    };
    ...
    var xd = function(a, b, c) {
        ...
        Ed = function(a) {
            ...
            for (a = a.parentNode; a && a != b; a = a.parentNode)
                if (11 == a.nodeType && a.host && (a = a.host), c = Ad(a, "position"), d = d && "static" == c && a != b.documentElement && a != b.body, !d && (a.scrollWidth > a.clientWidth || a.scrollHeight > a.clientHeight || "fixed" == c || "absolute" == c || "relative" == c)) return a;
            return null
        },
        Gd = function(a) {
            for (var b = new R(0, Infinity, Infinity, 0), c = Sb(a), d = c.a.body, e = c.a.documentElement, f = Yb(c.a); a = Ed(a);)
                if (!(H && 0 == a.clientWidth || J && 0 == a.clientHeight && a == d) && a != d && a != e && "visible" != Ad(a, "overflow")) {
                    var g =
                        Fd(a),
        ...
        Pd = I ? "MozUserSelect" : J || Eb ? "WebkitUserSelect" : null,
        Qd = function(a, b) {
    ...
    var Ud = function(a, b) {
        ...
        Vd = function(a) {
            ...
            var a = document.createElement("DIV"),
                b = J ? "-webkit" : I ? "-moz" : H ? "-ms" : Db ? "-o" : null,
                c = {
            ...
            if (b)
                for (var e in b) {
                    ...
                    if (null != f) {
                        var g;
                        g = e;
                        if (f instanceof cb) f = db(f);
                        else if ("style" == g.toLowerCase()) {
                            if (!ea(f)) throw Error('The "style" attribute requires goog.html.SafeStyle or map of style properties, ' +
                                typeof f + " given: " + f);
                            if (!(f instanceof fb)) {
                                var k = "",
                                    l = void 0;
                                for (l in f) {
                                    ...
                                    var q = f[l];
                                    if (null != q) {
                                        if (q instanceof cb) q = db(q), D(!/[{;}]/.test(q), "Value does not allow [{;}].");
                                        else if (ib.test(q)) {
                            ...
                            if (g.toLowerCase() in ub)
                                if (f instanceof nb) f instanceof nb && f.constructor === nb && f.a === mb ? f = "" : (Ba("expected object of type TrustedResourceUrl, got '" +
                                    f + "'"), f = "type_error:TrustedResourceUrl");
                                else if (f instanceof kb) f instanceof kb && f.constructor === kb && f.b === jb ? f = f.a : (Ba("expected object of type SafeUrl, got '" + f + "'"), f = "type_error:SafeUrl");
                            else if (v(f)) f instanceof kb || (f = f.ha ? f.aa() : String(f), lb.test(f) || (f = "about:invalid#zClosurez"), k = new kb, k.a = f, f = k), f = f.aa();
                            else throw Error('Attribute "' + g + '" on tag "div" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + f + '" given.');
                        }
                        f.ha && (f = f.aa());
                        D(v(f) || w(f), "String or number value expected, got " +
                            typeof f + " with value: " + f);
                        g = g + '="' + va(String(f)) + '"';
                        d = d + (" " + g)
                    }
                }
            ...
            if (0 == a.a) {
                ...
                a: {
                    var e = c,
                        f = a.v,
                        g = a.B;
                    if (e instanceof ne) null != f && Da(f, "opt_onFulfilled should be a function."),
                    null != g && Da(g, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"),
                    we(e, qe(f || r, g || null, a)),
                    d = !0;
                    else if (ke(e)) e.then(f, g, a),
                    d = !0;
                    else {
                        if (ea(e)) try {
                            var k = e.then;
    ...
    var Ne = function(a, b, c) {
        ...
        Me = /^<(body|caption|col|colgroup|head|html|tr|td|th|tbody|thead|tfoot)>/i,
        Ke = {};
    var Oe = function() {};
    ba(Oe);
    Oe.prototype.a = 0;
    ...
    S.prototype.removeChild = function(a, b) {
        if (a) {
            var c = v(a) ? a : a.G || (a.G = ":" + (a.Ib.a++).toString(36)),
                d;
    ...
    bf.prototype.b = function() {
        if (this.g) {
            var a = !this.Z && "move_offscreen" != this.qa,
                b = this.j();
    ...
    var kf = "StopIteration" in m ? m.StopIteration : {
    ...
    var pf = function(a) {
        ...
        qf = function(a, b, c) {
            ...
            else if (da(a) || v(a)) E(a, b, c);
            else {
                var d;
                if (a.Y && "function" == typeof a.Y) d = a.Y();
    ...
    var Cf = function(a) {
        ...
        Af = /[\x00\x22\x27\x3c\x3e]/g,
        Ef = /^(?!on|src|(?:style|action|archive|background|cite|classid|codebase|data|dsync|href|longdesc|usemap)\s*$)(?:[a-z0-9_$:-]*)$/i,
        yf = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g,
        zf = /</g;
    var Ff = function(a) {
    ...
    h.Ra = function() {
        ...
        if (!Gb) {
            var a = this.c,
                b = Ee(this.j(), "ease-out", 0, 1),
                c = Ee(this.j(), "ease-in", 1, 0);
            a.f = b;
            a.c = c
        }
        ad(this.j(), this.M)
    ...
    h.V = function() {
        ...
        var a = Te(this),
            b = this.a ? Vb("jfk-bubble-closebtn-id", this.a || this.f.a) : null;
    ...
    U.prototype.Y = function() {
        Yf(this);
        for (var a = this.a.J(), b = this.a.Y(), c = [], d = 0; d < b.length; d++)
    ...
    U.prototype.J = function(a) {
        Yf(this);
        var b = [];
        if (v(a)) $f(this, a) && (b = Ra(b, this.a.get(Zf(this, a))));
        else {
            a = this.a.J();
    ...
    */
    ...
    bg.prototype.cancel = function(a) {
        if (this.a) this.c instanceof bg && this.c.cancel();
        else {
            if (this.b) {
                var b = this.b;
                delete this.b;
    ...
    var kg = function(a) {
        ...
        fg = function(a) {
            ...
            a.c = b;
            d && (k = y(a.s, a, !0), d = y(a.s, a, !1), b instanceof bg ? (jg(b, k, d), b.B = !0) : b.then(k, d));
    ...
    Ng.prototype.log = function(a, b, c) {
        if (a.value >= Sg(this).value)
            for (x(b) && (b = b()), a = new Lg(a, String(b), this.f), c && (a.a = c), c = "log:" + a.getMessage(), m.console && (m.console.timeStamp ? m.console.timeStamp(c) : m.console.markTimeline && m.console.markTimeline(c)), m.msWriteProfilerMark && m.msWriteProfilerMark(c), c = this; c;) c = c.a
    };
    var Tg = {},
        Ug = null,
        Vg = function(a) {
    ...
    var oh = function(a) {
            if (a.b && "undefined" != typeof aa)
                if (a.w[1] && 4 == ph(a) && 2 == qh(a)) V(a.K, ih(a, "Local request error detected and ignored"));
                else if (a.m && 4 == ph(a)) Be(a.T, 0, a);
            else if (Q(a, "readystatechange"), 4 == ph(a)) {
                V(a.K, ih(a, "Request complete"));
                a.b = !1;
                try {
                    if (rh(a)) Q(a, "complete"), Q(a, "success");
                    else {
                        var b;
                        try {
    ...
    var yh = function(a) {
        ...
        Bh = function(a) {
            ...
            b = Ah;
            var d = yh(String.fromCharCode(116)),
                c = yh(String.fromCharCode(107)),
                d = [d(), d()];
            d[1] = c();
            for (var c = "&" + d.join("") + "=", d = [],
    ...
    Gh.prototype.a = function(a) {
        if (J || Eb)
            if (17 == this.I && !a.ctrlKey || 18 == this.I && !a.altKey || Hb && 91 == this.I && !a.metaKey) this.ea = this.I = -1; - 1 == this.I && (a.ctrlKey && 17 != a.keyCode ? this.I = 17 : a.altKey && 18 != a.keyCode ? this.I = 18 : a.metaKey && 91 != a.keyCode && (this.I = 91));
    ...
    h.Ua = function(a, b) {
        var c = !b,
            d = H || Db ? a.getElementsByTagName("*") : null;
        if (Pd) {
            if (c = c ? "none" : "", a.style && (a.style[Pd] = c), d)
                for (var e = 0, f; f = d[e]; e++) f.style && (f.style[Pd] = c)
        } else if (H || Db)
    ...
    var mi = function(a) {
        ...
        a = a || {};
        var c = tf,
            d = '<div role="button"' + (a.id ? ' id="' + Cf(a.id) + '"' : "") + ' class="',
            e, f;
        e = a || {};
    ...
    var ui = function(a) {
        ...
        if (a.query)
            if (a.Fb) {
                for (var b = b + '<div class="gtx-language"><select class="gtx-lang-selector">', c = a.Sb, d = c.length, e = 0; e < d; e++) var f = c[e],
                    b = b + ("auto" != f ? '<option value="' + uf(f[0]) + '" ' + (f[0] == a.Rb ? "selected" : "") + ">" + uf(f[1]) + "</option>" : "");
                ...
                if (a.kb) {
                    ...
                    for (e = 0; e < d; e++) {
                        ...
                        if (a.popup)
                            for (var f = f.terms, g = f.length, k = 0; k < g; k++) b += (0 != k ? ", " : "") + uf(f[k]);
                        else
                            for (f = f.terms, g = f.length, k = 0; k < g; k++) var l = f[k],
                                b = b + (3 > k ? (0 != k ? ", " : "") + uf(l) : "");
                        b += "</td></tr>"
                    }
                    b += "</table>"
    ...
    vi.prototype.a = function(a, b, c, d) {
        if (null != d) {
            ...
            Ve(b, g);
            ti(b, k, f);
            e = "https://translate.google.cn/?source=gtx_m#" + e + "/" + f + "/" + encodeURIComponent(window.selection);
    ...
    O(window, "mouseup", function(a) {
        if (0 == a.button && !Tb(document, "gtx-trans")) {
            ...
            Bg || "1" != Eg.a || !Eg.g || yi ? window.setTimeout(z(Gi, a), 0) : (zi = a, chrome.runtime.sendMessage({
                detectLanguage: 1
            }))
        }
    });
